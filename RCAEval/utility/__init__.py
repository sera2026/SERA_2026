...
def download_data(remote_url=None, local_path=None):
    ...
    if remote_url is None:
        remote_url = "https://github.com/phamqui{user}/baro/releases/download/0.0.4/simple_data.csv"
...
def download_multi_source_sample(local_path=None):
    ...
    download_data("https://github.com/phamqui{user}/RCAEval/releases/download/0.2.0/multi-source-data.zip", "multi-source-data.zip")
