...
from RCAEval.e2e.models import (
        iTransformer, TimeMixerpp, Dlinear, Fits, Mamba_backbone
    )
...
if __name__ == "__main__":
    data = pd.read_csv("/home/{user}/ws/cfm/tmp_data/cartservice_mem/1/data.csv")

    n = 30

    # read inject_time
    with open("/home/{user}/ws/cfm/tmp_data/cartservice_mem/1/inject_time.txt", "r") as f:
        inject_time = f.read()
