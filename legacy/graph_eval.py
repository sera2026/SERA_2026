...
def evaluate():
    ...
    for data_path in data_paths:
        ...
        # ====== READ TRUE GRAPH =====
        # for circa
        # /home/{user}/ws/RCAEval/data/syn_circa/10/0/cases/0/data.csv
        ...
        # for causil
        # /home/{user}/ws/RCAEval/data/syn_causil/10_services/synthetic/Graph0/data.csv
        if "syn_causil" in data_path:
...
def process(data_path):
    ...
    # === for rcd
    # /home/{user}/ws/RCAEval/data/syn_rcd/10/0/cases/0/data.csv
    if "_rcd" in data_path:
        num_node = int(basename(dirname(dirname(dirname(dirname(data_path))))))
        graph_idx = int(basename(dirname(dirname(dirname(data_path)))))
        case_idx = int(basename(dirname(data_path)))
