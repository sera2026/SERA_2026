...
[![CircleCI](https://dl.circleci.com/status-badge/img/gh/phamqui{user}/RCAEval/tree/main.svg?style=svg)](https://dl.circleci.com/status-badge/redirect/gh/phamqui{user}/RCAEval/tree/main)
[![Build and test](https://github.com/phamqui{user}/RCAEval/actions/workflows/build-and-test.yml/badge.svg)](https://github.com/phamqui{user}/RCAEval/actions/workflows/build-and-test.yml)
[![Upload Python Package](https://github.com/phamqui{user}/RCAEval/actions/workflows/python-publish.yml/badge.svg)](https://github.com/phamqui{user}/RCAEval/actions/workflows/python-publish.yml)
...
```bash
git clone https://github.com/phamqui{user}/RCAEval.git && cd RCAEval
```
...
- **BARO**: Licensed under the [MIT License](LICENSES/LICENSE-BARO). Original source: [BARO GitHub Repository](https://github.com/phamqui{user}/baro/blob/main/LICENSE).
...
[phamqui{user}\@gmail.com](mailto:phamqui{user}@gmail.com?subject=RCAEval)
